...
describe('users/notes', () => {
	...
	beforeAll(async () => {
		...
		const jpg = await uploadUrl(alice, 'https://raw.githubusercontent.com/h3zjp/misskey/h3zjp-v2023/packages/backend/test/resources/192.jpg');
		const png = await uploadUrl(alice, 'https://raw.githubusercontent.com/h3zjp/misskey/h3zjp-v2023/packages/backend/test/resources/192.png');
